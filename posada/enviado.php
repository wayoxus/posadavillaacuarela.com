...
<title>Enviado | Posada Villa Acuarela</title>
<meta name="author" content="Wayox Media C.A." />
<meta name="description" content="Posada Villa Acuarela, ecoturistica con tematica colonial y lujosa en Sanare, Edo Lara, Venezuela" />
...
<div class="container">
	...
	<div class="header-title-image">
    	...
    	<h1><span>Medios </span> de contacto</h1>
    </div>
    ...
    <div class="container_24">
        ...
        <div class="grid_6">
			...
			<div class="box box_black">
            	<div class="inner">
            		<h3 class="bordered"><span>REDES</span> SOCIALES:</h3>
			...
			<div class="box box_gray">
				<h3><span>Contactenos</span> DIRECTAMENTE:</h3>
